...
class _LampControlScreenState extends State<LampControlScreen>
  ...
  Widget _buildLampAssembly() {
    final swingOffset =
        math.sin(_wireSwing.value * math.pi * 4) * 15 * _wireSwing.value;
                          ...
                          decoration: BoxDecoration(
                            gradient: RadialGradient(
                              ...
                              colors: [
                                Color(
                                  0xFFFFF8DC,
                                ).withOpacity(0.9 * _lampFlicker.value),
                                Color(
                                  0xFFFFA500,
                                ).withOpacity(0.7 * _lampFlicker.value),
                                Color(
                                  0xFFFF8C00,
                                ).withOpacity(0.5 * _lampFlicker.value),
                                Color(
                                  0xFFFF6B35,
                                ).withOpacity(0.2 * _lampFlicker.value),
                                Colors.transparent,
                              ],
                                ...
                                decoration: BoxDecoration(
                                  gradient: LinearGradient(
                                    ...
                                    colors: [
                                      Color(
                                        0xFFFFF8DC,
                                      ).withOpacity(0.8 * _lampFlicker.value),
                                      Color(
                                        0xFFFFE4B5,
                                      ).withOpacity(0.9 * _lampFlicker.value),
                                      Color(
  ...
  Widget _buildWireWithPhysics() {
    ...
    final wireEnd = Offset(
      _wireEndPosition.dx + swingOffset,
      _wireEndPosition.dy + _wirePullDistance,
    );
        ...
        decoration: BoxDecoration(
          gradient: RadialGradient(
            ...
            colors: [
              Color(
                0xFFFFA500,
              ).withOpacity(0.2 * _roomGlow.value * _lampFlicker.value),
              Color(
                0xFFFF8C00,
              ).withOpacity(0.12 * _roomGlow.value * _lampFlicker.value),
              Color(
                0xFFFF6B35,
              ).withOpacity(0.06 * _roomGlow.value * _lampFlicker.value),
              Colors.transparent,
            ],
            stops: [0.0, 0.4, 0.7, 1.0],
          ),
        ...
        decoration: BoxDecoration(
          gradient: RadialGradient(
            ...
            colors: [
              Color(
                0xFFFFA500,
              ).withOpacity(0.4 * _roomGlow.value * _lampFlicker.value),
              Color(
                0xFFFF8C00,
              ).withOpacity(0.2 * _roomGlow.value * _lampFlicker.value),
              Color(
                0xFFFF6B35,
              ).withOpacity(0.1 * _roomGlow.value * _lampFlicker.value),
              Colors.transparent,
            ],
